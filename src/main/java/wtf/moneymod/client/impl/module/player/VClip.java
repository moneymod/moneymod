        ...
        if (mode == Mode.DEFAULT){
            ...
            if (mc.player.onGround) {
                ...
                for (double jumpOffset : packets)
                    mc.player.connection.sendPacket(new CPacketPlayer.Position(mc.player.posX, mc.player.posY + jumpOffset, mc.player.posZ, ground));
                mc.player.connection.sendPacket(new CPacketPlayer.Position(mc.player.posX, -(mc.player.posY + offset), mc.player.posZ, ground));

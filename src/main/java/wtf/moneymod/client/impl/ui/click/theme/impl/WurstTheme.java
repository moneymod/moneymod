...
public class WurstTheme extends AbstractTheme {
    ...
    private static final WurstTheme INSTANCE = new WurstTheme();
    ...
    @Override public void drawHeader(Panel panel, int x, int y, int w, int h, boolean hovered) {
        drawRect(x - 2, y - 2, x + w + 2, y, new Color(255, 111, 0, 199).getRGB());
    ...
    @Override public void drawPanelOutline(Panel panel, int x, int y, int w, int h, boolean hovered) {
        ...
        drawRect(x - 2, y, x, y + localHeight, new Color(255, 111, 0, 199).getRGB());
        drawRect(x + w, y, x + w + 2, y + localHeight, new Color(255, 111, 0, 199).getRGB());
        drawRect(x - 2, y + localHeight, x + w + 2, y + localHeight + 2, new Color(255, 111, 0, 199).getRGB());
    }
    ...
    @Override public void drawBooleanButton(Option<Boolean> container, int x, int y, int w, int h, boolean hovered) {
        drawRect(x, y, x + w, y + 12, new Color(255, 111, 0, 199).getRGB());
